...
#==================== Watched Indicators
{'setting_id': 'watched_indicators', 'setting_type': 'action', 'setting_default': '0', 'settings_options': {'0': 'gears', '1': 'Trakt', '2': 'Simkl', '3': 'MDBList'}},
#======+============= Trakt Cache
...
{'setting_id': 'external.cache_check', 'setting_type': 'boolean', 'setting_default': 'true'}, ########### KODIRDIL - cached-only default (was false) ###########
...
#==================== Hebrew Subtitles Settings (KODIRDIL)
{'setting_id': 'meta_language', 'setting_type': 'string', 'setting_default': 'he', 'settings_options': {'en': 'English', 'he': 'Hebrew (עברית)'}},
