...
########### KODIRDIL - Per-genre icons ###########
# Distinct icon per genre. Gears stock uses a single 'genres' icon for every category; we
# assign genre_X.png (genre_action, genre_comedy, ...) via the 'icon' key on each genre dict.
# Paired with the navigator.py patch that reads i.get('icon', 'genres') instead of hardcoded
# 'genres'. The 24 genre_*.png icons are bundled in resources/media/icons/.
##################################################
def movie_genres():
	return [
{'id': '28', 'name': 'Action', 'icon': 'genre_action'},        {'id': '12', 'name': 'Adventure', 'icon': 'genre_adventure'}, {'id': '16', 'name': 'Animation', 'icon': 'genre_animation'},
{'id': '35', 'name': 'Comedy', 'icon': 'genre_comedy'},        {'id': '80', 'name': 'Crime', 'icon': 'genre_crime'},         {'id': '99', 'name': 'Documentary', 'icon': 'genre_documentary'},
{'id': '18', 'name': 'Drama', 'icon': 'genre_drama'},          {'id': '10751', 'name': 'Family', 'icon': 'genre_family'},    {'id': '14', 'name': 'Fantasy', 'icon': 'genre_fantasy'},
{'id': '36', 'name': 'History', 'icon': 'genre_history'},      {'id': '27', 'name': 'Horror', 'icon': 'genre_horror'},       {'id': '10402', 'name': 'Music', 'icon': 'genre_music'},
{'id': '9648', 'name': 'Mystery', 'icon': 'genre_mystery'},    {'id': '10749', 'name': 'Romance', 'icon': 'genre_romance'},  {'id': '878', 'name': 'Science Fiction', 'icon': 'genre_scifi'},
{'id': '10770', 'name': 'TV Movie', 'icon': 'genre_soap'},     {'id': '53', 'name': 'Thriller', 'icon': 'genre_thriller'},   {'id': '10752', 'name': 'War', 'icon': 'genre_war'},
{'id': '37', 'name': 'Western', 'icon': 'genre_western'}
	]

def tvshow_genres():
	return [
{'id': '10759', 'name': 'Action & Adventure', 'icon': 'genre_action'}, {'id': '16', 'name': 'Animation', 'icon': 'genre_animation'},   {'id': '35', 'name': 'Comedy', 'icon': 'genre_comedy'},
{'id': '80', 'name': 'Crime', 'icon': 'genre_crime'},                  {'id': '99', 'name': 'Documentary', 'icon': 'genre_documentary'}, {'id': '18', 'name': 'Drama', 'icon': 'genre_drama'},
{'id': '10751', 'name': 'Family', 'icon': 'genre_family'},             {'id': '10762', 'name': 'Kids', 'icon': 'genre_kids'},          {'id': '9648', 'name': 'Mystery', 'icon': 'genre_mystery'},
{'id': '10763', 'name': 'News', 'icon': 'genre_news'},                 {'id': '10764', 'name': 'Reality', 'icon': 'genre_reality'},    {'id': '10765', 'name': 'Sci-Fi & Fantasy', 'icon': 'genre_scifi'},
{'id': '10766', 'name': 'Soap', 'icon': 'genre_soap'},                 {'id': '10767', 'name': 'Talk', 'icon': 'genre_talk'},          {'id': '10768', 'name': 'War & Politics', 'icon': 'genre_war'},
{'id': '37', 'name': 'Western', 'icon': 'genre_western'}
	]

def anime_genres():
	return [
{'id': '10759', 'name': 'Action & Adventure', 'icon': 'genre_action'}, {'id': '35', 'name': 'Comedy', 'icon': 'genre_comedy'},              {'id': '80', 'name': 'Crime', 'icon': 'genre_crime'},
{'id': '18', 'name': 'Drama', 'icon': 'genre_drama'},                  {'id': '10751', 'name': 'Family', 'icon': 'genre_family'},           {'id': '10762', 'name': 'Kids', 'icon': 'genre_kids'},
{'id': '9648', 'name': 'Mystery', 'icon': 'genre_mystery'},            {'id': '10765', 'name': 'Sci-Fi & Fantasy', 'icon': 'genre_scifi'},  {'id': '10768', 'name': 'War & Politics', 'icon': 'genre_war'},
{'id': '37', 'name': 'Western', 'icon': 'genre_western'}
	]
