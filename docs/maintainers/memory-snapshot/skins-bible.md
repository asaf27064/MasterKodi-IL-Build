---
name: skins-bible
description: THE reference for all 4 skins — architecture, deps, which files to edit for every change, no-clobber settings delivery, all traps (also committed at docs/maintainers/skins-bible.md)
metadata:
  type: project
